...
function About() {
  return (
    <div id="about" className="w-full min-h-screen bg-[#3D3D3D] px-8 lg:px-72">
      <div className="relative flex justify-end items-center mt-20">
        <div className="h-1 grow bg-white/20 self-end mb-4 mr-4 md:ml-20"></div>
        ...
        <div className="md:w-2/5 md:px-8 flex flex-col items-center">
          ...
          <div className="px-2 pt-4 flex flex-col items-center justify-center">
            ...
            <div className="mt-4 flex justify-center flex-wrap gap-2 text-lg">
              ...
              <span className="px-3 py-1 bg-[#232323] rounded-xl">MySQL</span>
              <span className="px-3 py-1 bg-[#232323] rounded-xl">Git</span>
              <span className="px-3 py-1 bg-[#232323] rounded-xl">
                Typescript
              </span>
            </div>
